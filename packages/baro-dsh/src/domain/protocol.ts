/* baro's TUI protocol v3 (docs/tui-protocol-v3.md) as this package knows it.
   The milestone subset is a type list by contract, so "is this certified
   outcome or live feed" is a membership test and nothing else. */
...
/** One human line per milestone — what a jobs panel or a parent log shows. */
