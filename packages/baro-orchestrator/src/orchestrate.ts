...
import { createTuiForwarders } from "./tui-forwarders/index.js"
...
export async function orchestrate(
    ...
    // BaroEvent forwarders: watch the bus, translate to TUI protocol on stdout.
    if (emitTui) {
        for (const forwarder of createTuiForwarders()) forwarder.join(env)
    }
