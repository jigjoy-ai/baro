 ...
 * one load-modify-persistPrdPreserving writer here needs no lock. Without this
 * the on-disk PRD only learned about merges at run end, and an interrupted run
