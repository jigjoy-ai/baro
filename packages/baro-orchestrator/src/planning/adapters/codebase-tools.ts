...
import {
    ...
    type ShellAccessContext,
} from "../../execution/shell-containment.js"
import { execFileCli } from "../../harness/exec-file-cli.js"
import { STORY_SHELL_BUDGET_MS } from "../../harness/environment.js"

export { safePath } from "../../execution/shell-containment.js"
...
async function runBash(
    ...
    const rejection = shellContainmentRefusal(cwd, command, access)
    if (rejection) {
